...
class x0{
    ...
    public x0() {
        ...
        int contador = 0;     // esta variables lleva Cuenta de las veces que han participado los jugadores 1 y 2.
        inicializarTablero();
    }
    // esta funcion sirve para iniciar el arreglo de cada casilla
    ...
    public void imprimirTablero(){
        //Esta funcion sirve para imprimir el tablero X0
    ...
    public void indicarTurno(){
        ...
        if(getTurno()==true)
            ...
            System.out.println("Jugador#1 Ingrese el numero donde desea jugar");

        else

            System.out.println("Jugador#2 Ingrese el numero donde desea jugar");
    }
        ...
        do{
            ...
            try{elegirPosicion(Integer.parseInt(entrada.readLine()));}
                ...
                if(getTurno()==true)
                    ...
                    System.out.println("-> -> Ingreso Un Caracter No Valido, Por Favor, Intente Nuevamente JUGADOR 1.<-<-");

                else

                    System.out.println(" -> -> Ingreso Un Caracter No Valido, Por Favor, Intente Nuevamente JUGADOR 2.<-<-");
            }
